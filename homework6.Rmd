...
appLogin <- function(memberID, currentGPS){
  ...
  #抓出memberID屬於的地方
 tr_members <- purrr::transpose(members)
 pick_memberID <- tr_members$memberID == memberID
  
  #找出gps
  pick_latestGPS <- tr_members$latestGPS[pick_memberID] 
  pick_latestGPS <- currentGPS
  pick_latestGPS
