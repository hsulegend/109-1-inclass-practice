...
```{r ans12}
# Game5Time
NBA1920Final567$Game5$Date5
NBA1920Final567$Game5$StartTime5
NBA1920Final567$Game5$TimeZone5
Game5Time <- c(NBA1920Final567$Game5$Date5,NBA1920Final567$Game5$StartTime5,NBA1920Final567$Game5$TimeZone5)
```
...
# TpeJason
library(lubridate)
NKAllen <- ymd_hm("2020-10-09 21:00",tz="America/New_York")
TpeJason <-  with_tz(NKAllen,tzone = "Asia/Taipei")
...
```{r ans15}
# ParisLouis
ParisLouis <- with_tz(NKAllen+minutes(15),tzone = "Europe/Paris")
...
```{r ans21}
# sumChNumbers
chNumbersfactor <- factor(chNumbers)
as.integer(chNumbersfactor) 
sumChNumbers <- sum(as.integer(chNumbersfactor) )
```
...
```{r ans22}
# sumChNumbersWith0
chNumbersWith0500 <- sample(chNumbersWith0,500,replace =  T)
chNumbersWith0500factor <- factor(chNumbersWith0500)
as.integer(chNumbersWith0500factor)
sumChNumbersWith0 <- sum(as.integer(chNumbersWith0500factor))
```
